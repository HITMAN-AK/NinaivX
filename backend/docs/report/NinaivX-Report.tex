...
% Renders figures/<file> if it exists, else a labelled placeholder box, so the
...
\newcommand{\imgorph}[2][\linewidth]{%
  \IfFileExists{figures/#2}%
    ...
    {\fbox{\parbox[c][3.6cm][c]{#1}{\centering\itshape [\,add\\ \texttt{figures/#2}\,]}}}}
...
\begin{minipage}[t]{0.44\linewidth}\centering
  \imgorph{screen-signup.png}\\[3pt]{\small (a) Sign-up / log-in}
\end{minipage}\hfill
\begin{minipage}[t]{0.44\linewidth}\centering
  \imgorph{screen-create.png}\\[3pt]{\small (b) Create-persona wizard}
\end{minipage}

\vspace{10pt}
\begin{minipage}[t]{0.44\linewidth}\centering
  \imgorph{screen-chat.png}\\[3pt]{\small (c) Text chat}
\end{minipage}\hfill
\begin{minipage}[t]{0.44\linewidth}\centering
  \imgorph{screen-voice.png}\\[3pt]{\small (d) Voice call}
\end{minipage}
\caption{Key screens of the NinaivX mobile application: (a) sign-up and log-in, (b) the three-step create-persona wizard, (c) the text-chat interface, and (d) the voice-call interface.}
\label{fig:screens}
\end{figure}
